...
const addOrRemoveSubCategoryToCategoryZodSchema = z.object({
  body: z.object({
    subCategories: z
      .array(
...
const addOrRemoveSubSubCategoryToSubCategoryZodSchema = z.object({
  body: z.object({
    subSubCategories: z
      .array(
        z.string().refine((val) => mongoose.Types.ObjectId.isValid(val), {
...
export const CategoriesValidations = {
  ...
  addOrRemoveSubCategoryToCategoryZodSchema,
  addOrRemoveSubSubCategoryToSubCategoryZodSchema,
};
